...
var request = function request(url, options) {
  ...
  return axiosInstance.request(Object.assign({
    url: url
  }, newOptions)).then(function (_ref) {
    var data = _ref.data;
    return data;
  });
};
var getTian = function getTian(url, options) {
...
var BASE_URL$1 = 'https://qyapi.weixin.qq.com';
...
function _getToken() {
  _getToken = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_ref) {
    var corpid, corpsecret, response;
    return regenerator.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          corpid = _ref.corpid, corpsecret = _ref.corpsecret;
          _context.prev = 1;
          _context.next = 4;
          return get(BASE_URL$1 + "/cgi-bin/gettoken?corpid=" + corpid + "&corpsecret=" + corpsecret);
        case 4:
          response = _context.sent;
          return _context.abrupt("return", response.access_token);
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](1);
          console.log('getToken error: ' + _context.t0);
    ...
    return regenerator.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 8;
          return post(BASE_URL + "/cgi-bin/message/send?access_token=" + accessToken, option);
        case 8:
          res = _context.sent;
        ...
        case 12:
          ...
          console.log('消息发送失败', _context.t0);
        case 15:
        case "end":
          return _context.stop();
      }
...
(function (MessageUrl) {
  // 每日简报
  MessageUrl["dailyBriefing"] = "http://api.tianapi.com/bulletin/index";
  // 彩虹屁
  MessageUrl["caihongpi"] = "https://apis.tianapi.com/caihongpi/index";
...
var Api = /*#__PURE__*/function () {
  ...
  /*#__PURE__*/
  function () {
    var _getDailyBriefing = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
      var res;
      return regenerator.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return getTian(MessageUrl.dailyBriefing);
          case 2:
            res = _context.sent;
  ...
  /*#__PURE__*/
  function () {
    var _getCaihongpi = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
      var res;
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return getTian(MessageUrl.caihongpi);
          case 2:
            res = _context2.sent;
...
getConfig().message;
var tianMessages = /*#__PURE__*/function () {
  ...
  return function tianMessages() {
    return _ref.apply(this, arguments);
  };
}();
function goodMorning() {
  return _goodMorning.apply(this, arguments);
}
function _goodMorning() {
  _goodMorning = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
...
function main() {
  if (MESSAGE_TYPE === 'goodAfternoon') ; else if (MESSAGE_TYPE === 'goodEvening') ; else {
    // 早安
    goodMorning();
  }
}
